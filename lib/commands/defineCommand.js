...
var defineRedisObject = (exports.defineRedisObject = function defineRedisObject(
  vm
) {
  return function(fn) {
...
// exported to test
var customCommand = (exports.customCommand = function customCommand(
  numberOfKeys,
  luaCode
) {
  return function customCommand2() {
    ...
    for (
      var _len = arguments.length, luaScriptArgs = Array(_len), _key = 0;
      _key < _len;
      _key++
    ) {
...
function defineCommand(command, _ref) {
  ...
  this[command] = (0, _command2.default)(
